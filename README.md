...
Compare Structures | Trains 6 different CNN structures tuned using Bayesian optimization. Compares the accuracy, sensitivity, specificity, and precision of these 6 structures.
